...
(custom-set-faces
 ...
 '(whitespace-newline ((t (:foreground "dark gray" :weight normal))))
 '(whitespace-space ((t (:background "LightYellow" :foreground "dark gray"))))
 '(whitespace-tab ((t (:background "beige" :foreground "dark gray")))))
